...
#
# Usage:
#   ./devops/docker/postgres/postgres.sh            # uses HOST=myserver
#   ./devops/docker/postgres/postgres.sh newserver  # target a different SSH alias
#
...
REMOTE_DIR="/root/tradstry/devops/docker/postgres"
