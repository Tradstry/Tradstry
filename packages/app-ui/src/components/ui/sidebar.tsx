...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@tradstry/app-ui/components/ui/sheet";
  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          // h-svh + overflow-hidden pin the app shell to the viewport; pages
          // scroll inside their content pane, never the window.
