...
import { aiQueryKey, useAiArtifact, useAiJobMutation } from "@tradstry/app-ui/hooks/ai";
import { useGraphQLSubscription } from "@tradstry/app-ui/lib/client";
import { RANGE_PRESETS } from "@tradstry/app-ui/lib/range-presets";
import { AI_JOB_EVENTS_SUBSCRIPTION } from "@tradstry/app-ui/lib/service/ai";
import type {
  AiArtifactEnvelope,
  AiArtifactKind,
  AiJobEvent,
} from "@tradstry/app-ui/lib/types/ai";
import type {
  AnalyticsRange,
