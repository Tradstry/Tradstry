    ...
    <div className="relative rounded-xl border border-white/10 bg-zinc-900/80 p-4 shadow-2xl shadow-blue-500/5">
      ...
      <div className="relative h-32 overflow-hidden rounded-lg bg-zinc-800/50">
        <svg viewBox="0 0 400 120" className="h-full w-full" preserveAspectRatio="none">
          ...
          <path d="M0,80 Q50,70 100,60 T200,40 T300,50 T400,20" fill="none" stroke="oklch(0.546 0.245 262.881)" strokeWidth="2" />
          <path d="M0,80 Q50,70 100,60 T200,40 T300,50 T400,20 L400,120 L0,120 Z" fill="url(#chartGrad)" />
        </svg>
      </div>
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-zinc-900/80 p-4 shadow-2xl shadow-blue-500/5">
      <div className="mb-3 flex items-center gap-2">
        ...
        <span className="text-xs font-medium text-zinc-400">AAPL Earnings Play — Mar 28</span>
      </div>
      ...
      <div className="mt-3 flex gap-2">
        <span className="rounded-full bg-blue-500/10 px-2 py-0.5 text-[10px] text-blue-400">earnings</span>
        <span className="rounded-full bg-purple-500/10 px-2 py-0.5 text-[10px] text-purple-400">swing</span>
        <span className="rounded-full bg-emerald-500/10 px-2 py-0.5 text-[10px] text-emerald-400">winner</span>
      </div>
    </div>
  );
}
    ...
    <div className="rounded-xl border border-white/10 bg-zinc-900/80 p-4 shadow-2xl shadow-blue-500/5">
      ...
      <div className="relative h-28 overflow-hidden rounded-lg bg-zinc-800/50">
        <svg viewBox="0 0 400 100" className="h-full w-full" preserveAspectRatio="none">
          <rect x="20" y="60" width="30" height="40" rx="2" fill="oklch(0.546 0.245 262.881)" opacity="0.6" />
          <rect x="65" y="40" width="30" height="60" rx="2" fill="oklch(0.546 0.245 262.881)" opacity="0.7" />
          <rect x="110" y="25" width="30" height="75" rx="2" fill="oklch(0.546 0.245 262.881)" opacity="0.8" />
          <rect x="155" y="45" width="30" height="55" rx="2" fill="oklch(0.546 0.245 262.881)" opacity="0.6" />
          <rect x="200" y="15" width="30" height="85" rx="2" fill="oklch(0.546 0.245 262.881)" opacity="0.9" />
          <rect x="245" y="30" width="30" height="70" rx="2" fill="oklch(0.546 0.245 262.881)" opacity="0.75" />
          <rect x="290" y="20" width="30" height="80" rx="2" fill="oklch(0.546 0.245 262.881)" opacity="0.85" />
          <rect x="335" y="10" width="30" height="90" rx="2" fill="oklch(0.546 0.245 262.881)" />
        </svg>
      </div>
    </div>
  );
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-6 md:grid-cols-2">
        <div>
          ...
          <div className="mt-8 flex gap-4">
            <SignUpButton>
              <Button size="lg" className="h-11 px-6 bg-white text-black hover:bg-zinc-200 text-sm">
                Get Started Free
              </Button>
            </SignUpButton>
            <SignInButton>
              <Button variant="outline" size="lg" className="h-11 px-6 border-white/20 text-zinc-300 hover:bg-white/10 hover:text-white text-sm">
                Sign In
              </Button>
            </SignInButton>
          </div>
...
const features = [
  {
    ...
    description: "Automated behavioral analysis, pattern recognition, and personalized recommendations to sharpen your edge.",
  },
  {
    icon: Edit02Icon,
    title: "Advanced Journaling",
    description: "Rich text editor with trade tagging, playbooks, and multimedia support to capture every decision.",
  },
  {
    icon: ChartLineData02Icon,
    title: "Real-time Analytics",
    description: "Performance tracking with risk metrics, P&L analysis, and market correlation insights.",
  },
  {
    icon: BankIcon,
    title: "Brokerage Integration",
    description: "Connect your accounts for automatic trade importing and real-time position tracking.",
  },
  {
    icon: News01Icon,
    title: "Market Data",
    description: "Live quotes, historical data, technical indicators, and curated news aggregation.",
  },
  {
    icon: AiChat02Icon,
    title: "AI Chat",
    description: "Interactive AI assistant for trading analysis, strategy discussions, and on-demand reports.",
  },
];
    ...
    <section id="features" className="py-24">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-center text-zinc-400">
          A complete toolkit for tracking, analyzing, and improving your trading performance.
        </p>
          ...
          {features.map((feature) => (
            ...
            >
              <div className="flex size-10 items-center justify-center rounded-lg bg-white/5">
                <HugeiconsIcon icon={feature.icon} className="size-5 text-zinc-300" />
              </div>
...
const showcases = [
  {
    ...
    description: "See your entire portfolio at a glance. Real-time P&L, open positions, and market overview — all in one place.",
    mockup: "dashboard",
  },
  {
    title: "Journal every decision",
    description: "Rich text editor with trade context, custom tags, and AI-powered search. Never lose the reasoning behind a trade.",
    mockup: "journal",
  },
  {
    title: "Analytics that find your edge",
    description: "Deep performance analysis with risk metrics, behavioral patterns, and AI-generated insights to refine your strategy.",
    mockup: "analytics",
  },
];
...
const steps = [
  {
    ...
    description: "Link your trading accounts in seconds. We import your trades automatically.",
  },
  {
    number: "2",
    icon: PencilEdit02Icon,
    title: "Journal your trades",
    description: "Add context, tags, and notes to every trade. Build your personal playbook.",
  },
  {
    number: "3",
    icon: AiBrain01Icon,
    title: "Get AI insights",
    description: "Our AI analyzes your patterns and delivers personalized recommendations.",
  },
];
          ...
          {steps.map((step) => (
            <div key={step.number} className="relative text-center">
              <div className="mx-auto flex size-16 items-center justify-center rounded-full border border-white/10 bg-zinc-900">
                <HugeiconsIcon icon={step.icon} className="size-6 text-zinc-300" />
              </div>
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mx-auto mt-16 max-w-md rounded-2xl border border-white/10 bg-zinc-900/50 p-8">
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-zinc-400">No credit card required</p>
          </div>
          <ul className="mt-8 space-y-3">
            {pricingFeatures.map((feature) => (
              <li key={feature} className="flex items-center gap-3 text-sm text-zinc-300">
                <svg className="size-4 shrink-0 text-emerald-400" viewBox="0 0 16 16" fill="none">
          ...
          <SignUpButton>
            <Button size="lg" className="mt-8 h-11 w-full bg-white text-black hover:bg-zinc-200 text-sm">
              Get Started Free
            </Button>
          </SignUpButton>
        </div>
  ...
  return (
    <section className="relative overflow-hidden py-24">
      ...
      <div className="relative mx-auto max-w-6xl px-6 text-center">
        ...
        <SignUpButton>
          <Button size="lg" className="mt-8 h-11 px-8 bg-white text-black hover:bg-zinc-200 text-sm">
            Get Started Free
          </Button>
        </SignUpButton>
      </div>
